...
const ChangeLoginModal = ({showModal, closeModal, showSuccessMessage, error}) => {
    return (
                            ...
                            <div className="bg-white px-4 pb-6 pt-5 sm:p-6 sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left sm:w-full">
                                    <Dialog.Title as="h3"
                                        ...
                                        {showSuccessMessage && "Login has been successfully changed."}
                                        {error && "Login has not been changed"}
                                        <button
                                            type="button"
                                    ...
                                    <div className="mt-2">
                                        <p className="text-sm text-gray-500">
                                            {showSuccessMessage && "The login has been successfully changed. You can now use it without interference"}
