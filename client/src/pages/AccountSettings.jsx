        ...
        <>
            ...
            <div className="col-span-8 bg-slate-200 p-6 shadow-xl shadow-slate-200/50">
                <div className="grid grid-cols-12 gap-4">
                    <h1 className={`col-start-1 col-end-13 md:col-end-${currentUser.googleAccount ? '7' : '5'} text-black text-start my-auto`}>
                        Email
                    </h1>
                    <div
                        className={`col-start-1 col-end-${currentUser.googleAccount ? '13' : '10'} flex flex-col my-auto`}>
